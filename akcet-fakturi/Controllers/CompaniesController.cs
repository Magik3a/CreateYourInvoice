...
namespace akcet_fakturi.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CompanyID,UserId,IdAddress,CompanyName,CompanyMol,CompanyBulsatat,CompanyDescription,CompanyPhone,IsPrimary,DateCreated,DateModified")] Company company)
        {
